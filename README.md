...
| Abstraction | **Un mécanisme / une pratique servant à réduire le code d'un niveau de détail en proposant une représentation simplfiée.** https://onvaessayer.org/mobileCSP/unit2/2_08.php |
